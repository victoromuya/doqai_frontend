      ...
      <div className="grid gap-3 sm:grid-cols-3">
        {ACTIONS.map((a) => {
          ...
          return (
            ...
            >
              <div className="font-display text-2xl">{a.label}</div>
              <div className={`mt-1 font-mono text-[11px] uppercase tracking-widest ${active ? "text-background/70" : "text-muted-foreground"}`}>
                {a.hint}
              </div>
            </button>
          );
